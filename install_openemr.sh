...
sudo apt install apache2 mariadb-common mariadb-server php7.4 php7.4-common php7.4-mysql php7.4-xml php7.4-mbstring php7.4-curl unzip -y
echo
echo "DONE"
echo
...
echo
wget https://sourceforge.net/projects/openemr/files/latest/download/openemr-7.0.0.tar.gz
sudo unzip openemr-7.0.0.tar.gz
